...
class Cell:
    ...
    def draw(self, _x1, _y1, _x2, _y2):
        ...
        if not self.has_left_wall:
            no_left_wall = Line(Point(_x1, _y1), Point(_x1, _y2))
            self._win.draw_line(no_left_wall, "sky blue")
        ...
        if not self.has_right_wall:
            no_right_wall = Line(Point(_x2, _y1), Point(_x2, _y2))
            self._win.draw_line(no_right_wall, "sky blue")
